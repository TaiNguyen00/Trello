    ...
    columns: [
      {
        ...
        cardOrderIds: ['card-id-06', 'card-id-02', 'card-id-03', 'card-id-04', 'card-id-05', 'card-id-01', 'card-id-07'], // sắp xếp 1 mảng dựa trên mảng gốc
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
            ...
            cover: 'https://i.pinimg.com/736x/1e/9e/b7/1e9eb7e6f50545000bbb8e37b9681d12.jpg',
